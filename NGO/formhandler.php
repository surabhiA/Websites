...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: sagraw01@seattlecentral.edu' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from Asha Kiran website'; // if your client has more than one web site, you can put the site name here.

...
$body ="Here is the message from the Portal Page:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: agrawal.surabhi16@gmail.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from the Portal Page'; // if your client has more than one web site, you can put the site name here.
...
mail ('sagraw01@seattlecentral.edu', $subject, $body, $from);
